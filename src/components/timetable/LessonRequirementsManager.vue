      ...
      <table class="w-full">
        <thead class="bg-slate-50 border-b border-slate-200">
          <tr>
            ...
            <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase">Double</th>
        ...
        <tbody class="divide-y divide-slate-200">
          <tr v-for="req in requirements" :key="req.id" class="hover:bg-slate-50">
            ...
            <td class="px-6 py-4 text-sm text-slate-600">
              <span v-if="req.double_lesson_allowed" class="text-green-600">Yes</span>
...
const getActiveSessionId = () => {
  // This should get the active session from the parent or store
