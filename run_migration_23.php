...
try {
    ...
    $db->exec("DROP TABLE IF EXISTS lesson_observation_rounds");
    $db->exec("DROP TABLE IF EXISTS lesson_observations");
...
try {
    ...
    $db->exec($sql);
    echo "Lesson observation rounds table created successfully.\n";
} catch (PDOException $e) {
    echo "Error creating lesson observation rounds table: " . $e->getMessage() . "\n";
}
