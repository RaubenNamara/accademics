-- Fix timetable schema: create table without room and fix unique constraints

-- Create timetable table (without room column)
CREATE TABLE IF NOT EXISTS timetable (
  ...
  -- Prevent duplicate slots for same class in same period (including stream)
